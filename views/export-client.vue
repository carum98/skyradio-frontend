...
.export-client {
    ...
    --color-pdf: 232, 78, 61;
    --color-xlsx: 46, 204, 112;
    --color-csv: 51, 152, 219;
    ...
    & input[type="radio"] {
        ...
        &:checked + label[for="pdf"] {
            background-color: rgba(var(--color-pdf), 0.1);
            color: rgb(var(--color-pdf));
        }

        &:checked + label[for="xlsx"] {
            background-color: rgba(var(--color-xlsx), 0.1);
            color: rgb(var(--color-xlsx));
        }

        &:checked + label[for="csv"] {
            background-color: rgba(var(--color-csv), 0.1);
            color: rgb(var(--color-csv));
        }
    }
