...
<template>
    <div class="table-action-buttons">
        <button @click="openFilters({ rootProps: { anchor: $event.target } })">
        ...
        <button @click="openSort({ rootProps: { anchor: $event.target } })">
        ...
        <button @click="openColumns({ rootProps: { anchor: $event.target } })">
